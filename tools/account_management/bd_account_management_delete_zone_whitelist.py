"""bd_account_management_delete_zone_whitelist — auto-generated tool for DELETE /zone/whitelist.
...
async def bd_account_management_delete_zone_whitelist() -> dict[str, Any]:
    """Call DELETE /zone/whitelist.

    From: DELETE /zone/whitelist

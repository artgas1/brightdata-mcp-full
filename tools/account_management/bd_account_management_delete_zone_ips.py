"""bd_account_management_delete_zone_ips — auto-generated tool for DELETE /zone/ips.
...
async def bd_account_management_delete_zone_ips() -> dict[str, Any]:
    """Call DELETE /zone/ips.

    From: DELETE /zone/ips

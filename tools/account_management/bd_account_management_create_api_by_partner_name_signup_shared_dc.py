"""bd_account_management_create_api_by_partner_name_signup_shared_dc — auto-generated tool for POST /api/{PARTNER_NAME}/signup_shared_dc.
...
async def bd_account_management_create_api_by_partner_name_signup_shared_dc(partner_name: str, zone: str | None = None) -> dict[str, Any]:
    ...
    """
    path = f"/api/{partner_name}/signup_shared_dc"
    params: dict[str, Any] = {}
    if zone is not None:
        params["zone"] = zone

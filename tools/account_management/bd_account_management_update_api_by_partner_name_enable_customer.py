"""bd_account_management_update_api_by_partner_name_enable_customer — auto-generated tool for PUT /api/{PARTNER_NAME}/enable_customer.
...
async def bd_account_management_update_api_by_partner_name_enable_customer(partner_name: str, id: str) -> dict[str, Any]:
    ...
    """
    path = f"/api/{partner_name}/enable_customer"
    params: dict[str, Any] = {}
    params["id"] = id
